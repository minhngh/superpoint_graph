...
def compute_sp_graph(xyz, d_max, in_component, components, labels, n_labels):
    ...
    graph["se_inverse_delta_mean"] = np.zeros((n_sedg, 3), dtype='float32')
    graph["se_inverse_delta_std"] = np.zeros((n_sedg, 3), dtype='float32')
    graph["se_inverse_delta_norm"] = np.zeros((n_sedg, 1), dtype='float32')
    ...
    graph["se_inverse_delta_centroid"] = np.zeros((n_sedg, 3), dtype='float32')
    graph["se_inverse_length_ratio"] = np.zeros((n_sedg, 1), dtype='float32')
    graph["se_inverse_surface_ratio"] = np.zeros((n_sedg, 1), dtype='float32')
    graph["se_inverse_volume_ratio"] = np.zeros((n_sedg, 1), dtype='float32')
    graph["se_inverse_point_count_ratio"] = np.zeros((n_sedg, 1), dtype='float32')
    if has_labels:
